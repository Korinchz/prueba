<?php 
    ...
    switch($_GET["op"]){
        ...
        case "listar":
            ...
            foreach($datos as $row) {
                ...
                if($row["rol_id"] == "1"){
                    ...
                    $sub_array[] = '<span class="label label-pill label-gray">Soporte</span>';
                }

                $sub_array[] = '<button type="button" onClick="editar('.$row["usu_id"].');" id="'.$row['usu_id'].'" class="btn btn-inline btn-warning btn-sm ladda-buttom"><div><i class="fa fa-edit"></i></div></button>';
        ...
        case "eliminar":
            ...
            $user = $_POST["usu_id"];
            $mysql->query("call Del_usuario($user)");
        break;
